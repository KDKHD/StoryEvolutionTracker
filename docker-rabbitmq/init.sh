...
rabbitmqctl add_user $RABBITMQ_CLIENT_USER $RABBITMQ_CLIENT_PASSWORD 2>/dev/null ; \
rabbitmqctl set_user_tags $RABBITMQ_CLIENT_USER management ; \
...
echo "*** API User:  '$RABBITMQ_CLIENT_USER' with password '$RABBITMQ_CLIENT_PASSWORD' completed. ***" ; \
